...
<center>图1.1 AOS-NET组网中间件架构</center>
![](file:///C:/Users/ADMINI~1/AppData/Local/Temp/msohtmlclip1/01/clip_image002.gif)
##  AOS-NET组网中间件ubus封装定义
...
![](file:///C:/Users/ADMINI~1/AppData/Local/Temp/msohtmlclip1/01/clip_image002.gif)
<center>图2.1 ubus消息工作原理实例</center>
client2进行请求的整个过程为：
...
|  <img width=20/>对象名           |  <img width=50/>方法名           |  <img width=100/>参数   |  <img width=100/>描述    |
|:--------------:|:--------------:|:---------------------:|:----------------------:|
...
<font color="#2DC26B"><center>表2.4.1 - 2 设备基本信息返回值参数</center></font>

|      参数名       | <img width=100/>类型 | <img width=150/>读写 |                                                                                                                                                                                                                                                                                        <img width=200/>描述                                                                                                                                                                                                                                                                                        | <img width=200/>是否必须 |
|:-----------------:|:--------------------:|:--------------------:|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------:|
...
<center>表2.4.2 -1设备硬件信息对象方法</center>

|          <img width=100/>对象名              |        <img width=100/>方法名            |  <img width=100/>参数                                      |                                                          <img width=100/>返回参数                                                               |      <img width=100/>描述        |
|:-----------------------------------------:|:-------------------------------------:|:--------------------------------------------------------:|:-------------------------------------------------------------------------------------------------------------------------------------------:|:------------------------------:|
|      ahsapd.hardware                      |      getHardware                      |           无                                              |      { "ahsapd. hardware": { "cpuType": "", "flashSize": , "ramSize": , "cpuOccupancyRate": , "ramOccupancyRate":  } }                      |                                |  
...
<center>表2.4.2 – 2 设备硬件信息返回值参数</center>

|      <img width=100/><img width=100/>参数名      |      <img width=100/>类型      | <img width=100/>读写权限 |           <img width=100/>描述            | <img width=100/>是否必须 |
|:----------------:|:--------------:|:--------:|:-------------------------:|:--------:|
...
<center>表2.4.3 -1设备端口信息对象方法</center>

|  <img width=100/>对象名        |  <img width=100/>方法名       |  <img width=100/>参数  |  <img width=100/>返回参数                                                                                                                                                                                                                            |  <img width=100/>描述    |
|:---------------------------:|:--------------------------:|:--------------------:|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------:|:------:|
|  ahsapd.port                |  getPortInfo               |  无                   |  { "ahsapd. port":{  "portInfoList"：[{ "index": 1 , "portType": 0 , "portRate": "XXX" , "portMac": "XXX", "portConnection":X }， { "index": 2 , "portType": 1 , "portRate": "XXX" , "portMac": "XXX" , "portConnection": X } ] } }                |        |  
...
<center>表2.4.3- 2 设备端口返回值参数</center>

|  <img width=100/>参数名           |  <img width=100/>类型             |  <img width=100/>读写权限  |  <img width=100/>描述                                                     |  <img width=100/>是否必须  |
|:------------------------------:|:-------------------------------:|:----------------------:|:-----------------------------------------------------------------------:|:----------------------:|
...
<center>表2.4.4 -1设备上行状态信息对象方法</center>

|  <img width=100/>对象名           |  <img width=100/>方法名         |  <img width=100/>参数  |  <img width=100/>返回参数                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |  <img width=100/>描述  |
|:-------------------------------|:-----------------------------|:---------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:---------------------|
|  ahsapd.uplink                 |  getUplinkInfo               |  无                   |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |                      |  
...
<center>表2.4.4 - 2设备上行状态返回值参数</center>
...
<center>表2.4.5 - 1下挂设备信息对象方法</center>
...
<center>表2.4.5 - 2下挂设备信息主动上报消息定义</center>
...
<center>表2.4.5 -3下挂设备列表信息返回值参数</center>
...
<center>表2.4.5- 4下挂设备数量信息返回值字段</center>
...
<center>表2.4.6 - 1设备WIFI配置信息对象方法</center>
...
<center>表2.4.6 – 2 wifi信息变化主动上报消息定义</center>
...
<center>表2.4.6 - 3设备WIFI配置信息参数</center>
...
<center>表2.4.7 - 1 设备WIFI统计信息对象方法</center>
...
<center>表2.4.7 - 2设备WIFI统计信息参数</center>
...
<center>表2.4.8 - 1 设备周边WIFI信息对象方法</center>
...
<center>表2.4.8 - 2设备周边WIFI信息参数</center>
...
<center>表2.4.9 - 1 设备漫游配置信息对象方法</center>
...
<center>表2.4.9- 3 设备漫游配置信息参数</center>
...
<center>表2.4.10 - 1 设备定时任务对象方法</center>
...
<center>表2.4.10 - 2 设备定时任务参数</center>
...
<center>表2.4.11 - 1 设备黑白名单对象方法</center>
...
<center>表2.4.11 - 2 设备黑白名单配置参数</center>

|  <img width=100/>参数名               |  <img width=100/>类型              |  <img width=100/>读写权限    |  <img width=100/>描述                                                                                                                                                  |  是否必须      |
|:------------------:|:----------------:|:--------:|:----------------------------------------------------------------------------------------------------------------------------------------------------:|:----------:|
...
<center>表2.4.12 - 1 设备操作指令对象方法</center>
...
<center>表2.4.12 – 2 操控指令event响应上报消息定义</center>
...
<center>表2.4.13 - 1 设备配置保存对象方法</center>
...
<center>表2.4.14 - 1 设备配置保存对象方法</center>
...
<center>表2.4.14 -2 mesh信息变化消息通知</center>
...
<center>表2.4.15 - 1 设备网络限速对象方法</center>
...
<center>表2.4.15 - 2设备网络限速参数</center>
...
<center>表2.4.18 – 1组网设备VLAN配置对象方法</center>
...
<center>表2.4.19 – 2 设备VLAN配置参数</center>
